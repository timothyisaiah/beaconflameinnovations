...
export function Hero() {
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-gradient-to-b from-[#020203]/55 via-[#0a0610]/42 to-[#0a0610]/32"
        aria-hidden
      />
      <motion.div
      ...
      >
        ...
        <h1 className="font-display text-[clamp(2.25rem,6vw,4.25rem)] leading-[1.05] text-[#f4f0f8] font-semibold tracking-tight">
          Engineering intelligent systems for the long game.
        </h1>
        <p className="mt-8 text-lg md:text-xl text-[#c8cdd8] max-w-2xl leading-relaxed">
        ...
        <div className="mt-12 flex flex-wrap items-center gap-4 pointer-events-auto">
          ...
          <button
            ...
            className="group inline-flex items-center gap-2 text-sm font-medium text-[#e8ecf4]/85 hover:text-[#87158c] transition-colors"
          >
